...
router.post('/bulkImport', authController.protect, subCategoryController.bulkImportSubCategories);
router.post('/bulkUpdate', authController.protect, subCategoryController.bulkUpdateSubCategories);
